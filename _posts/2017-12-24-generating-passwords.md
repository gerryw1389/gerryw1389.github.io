...
date: 2017-12-24T04:40:30+00:00
author: gerryw1389
layout: single
classes: wide
permalink: /2017/12/generating-passwords/
tags:
  - Windows
  - Security
tags:
...
This script is used to generate random passwords.

### To Resolve:

1. This is the cmdline version that I like to use with my CustomMenuGUI script:
   ...
   Or the GUI version (copied from [the Agreeable Cow's site](http://www.theagreeablecow.com/2014/08/password-and-phrase-generator-using.html)):
